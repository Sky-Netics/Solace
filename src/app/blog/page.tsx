    ...
    return(
        ...
        <div className="flex max-md:flex-col">
            ...
            <div className="w-[35%] max-md:w-[100%]">
                ...
                <div className="px-[100px] mb-8 mt-8 max-md:px-5">
                ...
                <div className="bg-white w-[332px] mx-auto px-5 py-5 max-xl:w-[250px] max-md:w-[100%]">
                    <div className="border w-[292px] flex items-center pl-5 bg-gray-50 max-xl:w-[200px] max-md:w-[100%]">
                        <div >
            ...
            <div className="w-[65%] pt-[175px] pr-[100px] max-lg:pr-5 max-md:w-[100%] max-md:px-10 max-md:pt-12">

                <div className="w-full flex items-center justify-between text-[#616161] text-[14px]">
                    <p>
                        3 posts
                    </p>
