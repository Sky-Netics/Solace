...
const Register = () => {
    ...
    const registerBtn = useRef<HTMLButtonElement|null>(null);
    ...
    const activeBtn = ()=>{
        if (registerBtn.current)
            ...
            else registerBtn.current.disabled = true;
    }
        ...
        <div>
            ...
            <div className="space-y-4">
                <div className="space-y-4 md:space-y-0 md:flex md:gap-5">
                    <div>
                        <label className="text-lightLight" htmlFor="firstname">First Name</label>
                        <input className="h-12 bg-transparent w-full border focus:outline-none px-3" type="text" name="firstname" id="firstname" />
                    </div>
                    <div>
                        <label className="text-lightLight" htmlFor="lastname">Last Name</label>
                        <input className="h-12 bg-transparent w-full border focus:outline-none px-3" type="text" name="lastname" id="lastname" />
                    </div>
                </div>
                <div className="space-y-4 md:space-y-0 md:flex md:gap-5">
                    <div>
                        <label className="text-lightLight" htmlFor="Email">Email</label>
                        <input className="h-12 bg-transparent w-full border focus:outline-none px-3" type="email" name="Email" id="Email" />
                    </div>
                    <div>
                        <label className="text-lightLight" htmlFor="phonenumber">Phone Number</label>
                        <input className="h-12 bg-transparent w-full border focus:outline-none px-3" type="text" name="phonenumber" id="phonenumber" />
                    </div>
                </div>
                <div>
                    <label className="text-lightLight" htmlFor="Password">Password</label>
                    <div className="h-12 w-full flex border items-center px-3">
                        <input ref={passwordInput} className="w-full focus:outline-none bg-background text-foreground" type="password" name="Password" id="Password" />
                        {show ?
            ...
            <div className="border my-3 p-5 space-y-2">
            ...
            <div className="flex gap-5 mx-2 my-7">
                <input onChange={activeBtn} ref={checkbox} className="w-5 h-5" type="checkbox" />
                <p className="text-sm">I read and agree to Terms & Conditions and Privacy Policy.</p>
            </div>
            <div className="mt-6">
                <button ref={registerBtn} disabled className="w-full h-12 bg-foreground text-background rounded-3xl">Create Account</button>
            </div>
        </div>
     );
}
